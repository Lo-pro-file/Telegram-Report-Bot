...
async def handle_start(bot:Client, message:Message):
    ...
    Btn = [
        ...
        [InlineKeyboardButton(text='🌻Uᴘᴅᴀᴛᴇs', url='https://t.me/Kdramaland_Official'), InlineKeyboardButton(text='🌨️Aʙᴏᴜᴛ', callback_data='about')],
        [InlineKeyboardButton(text='❄️Dᴇᴠᴇʟᴏᴘᴇʀ', url='https://t.me/Snowball_Official')]
        ]
