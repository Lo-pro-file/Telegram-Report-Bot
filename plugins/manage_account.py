...
async def make_config(bot: Client, msg: Message):
    try:
        if config_path.exists():
            ...
            ms = await msg.reply_text(text="**Please Wait...**")
            ...
            await msg.edit(text=Txt.MAKE_CONFIG_DONE_MSG.format(n.text), reply_to_message_id=n.id, reply_markup=InlineKeyboardMarkup(acocunt_btn))
